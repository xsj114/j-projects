...
准备资料：<br/>
1.抖音账号：建议绑定的是法人或店长的号码<br/>
2.银行卡：以企业法人的身份开通的<br/>
3.营业执照照片：经营类目要确认<br/>
4.行业资质证件：不同行业不一样<br/>
...
主页装修就是,将账号的昵称（昵称要与账号主体相关），头像（最好不要用人物头像，可使用店铺相关的图片做头像，例如店铺logo，门头照片，食物照片，内部环境照片），背景图（使用店铺相关的图片做背景图，例如店铺logo，门头照片，食物照片，内部环境照片,团队成员照片），简介（最多4行，超过会折叠，需突出店铺的价值和差异点）这四要素设置好<br/>
